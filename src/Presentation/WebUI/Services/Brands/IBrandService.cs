...
namespace WebUI.Services.Brands
{
    public interface IBrandService
    {
        ...
        Task<ApiResponse> AddAsync(Brand model, CancellationToken cancellation = default);
        Task<ApiResponse> EditAsync(Brand model, CancellationToken cancellation = default);
